#########################################################
#  	SCRIPT TO GENERATE 16S COVERAGE.					#
#########################################################
...
# read bedtools file
df=read.table(paste(sampleCoverageDir,sampleName,'_16S_coverage.txt',sep = ''), sep="\t")
# Name each column
...
write.table(cov_def, file=paste(sampleCoverageDir,sampleName,"16S_coverageTable.txt", sep= ''),sep="\t",row.names=F)
