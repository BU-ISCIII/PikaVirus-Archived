...
# Arguments (for the map_bacteria function):
# $1 (bacDB) = Directory of bacteria reference genome (REFERENCES/BACTERIA_GENOME_REFERENCE/).
# $2 (sampleDir) = Directory containing host-free files. (ANALYSIS/04-noHost/sampleName/)
...
echo -e " Execute map_bacteria $sampleName" >> "${sampleAnalysisLog}"
map_bacteria $sampleName
