...
<nav class=\"navbar navbar-inverse\" data-spy=\"affix\" data-offset-top=\"137\">
  <ul class=\"nav navbar-nav\">
    ...
    <li class=\"active\"><a href=\"samples.html\"><img class=\"icon-bar\" src='https://raw.githubusercontent.com/BU-ISCIII/PikaVirus/develop/html/img/test-tube.png' img> Results per sample</a></li>
    ...
    <li><a href=\"info.html\"><img class=\"icon-bar\" src='https://raw.githubusercontent.com/BU-ISCIII/PikaVirus/develop/html/img/book.png' img> What is this?</a></li>
  </ul>
</nav>
...
do
	...
	<li id=\"$in\" class=\"dropdown\"><a class=\"dropdown-toggle\" data-toggle=\"dropdown\" href=\"#\">$in</a>
        <ul class=\"dropdown-menu\">
          <li id=\"${in}-bac\" data-target=\"${in}-bac\"><a href=\"#\"><img class=\"icon\" src='https://raw.githubusercontent.com/BU-ISCIII/PikaVirus/develop/html/img/bacteria.png' img>  Bacteria</a></li>
          <li id=\"${in}-vir\" data-target=\"${in}-vir\"><a href=\"#\"><img class=\"icon\" src='https://raw.githubusercontent.com/BU-ISCIII/PikaVirus/develop/html/img/virus1.png' img>  Virus</a></li>
          <li id=\"${in}-fun\" data-target=\"${in}-fun\"><a href=\"#\"><img class=\"icon\" src='https://raw.githubusercontent.com/BU-ISCIII/PikaVirus/develop/html/img/fungi.png' img>  Fungi</a></li>
        </ul>
      </li>
	" >> $result_page
done
